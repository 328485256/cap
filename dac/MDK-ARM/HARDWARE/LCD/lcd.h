...
void LCD_Draw_Solid_Point(u16 x,u16 y,u16 color);//画实心点
void LCD_Draw_Output_waveform(u16 x_max,u16 y_max,u16 x_min,u16 y_min,u16 color,uint16_t data,uint16_t* Waveform_Date);//画出波形，x_max，y_max，x_min，y_min限制区域 color颜色，date更新的数据
